...
export const closePopupButton = popupEditProfile.querySelector('#pop-up-edit-profile-close');
...
export const addPictureButon = document.querySelector('.profile__button-add');
export const editFormPicture = document.querySelector('#edit-form-picture');
...
export const editFormPictureName = editFormPicture.querySelector('#name');
export const editFormPictureDesc = editFormPicture.querySelector('#description');